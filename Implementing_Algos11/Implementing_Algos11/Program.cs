...
// Quadratic Algorithms (Bubble Sort, Insertion Sort):
// Their O(n^2) time complexity means that as the array size increases,
// the number of comparisons and swaps grows quadratically.
// This makes them impractical for sorting large datasets.
// Logarithmic Algorithms (Merge Sort, Quick Sort): Their O(n log n) time complexity allows them
// to handle large datasets much more efficiently by breaking down the problem
// and processing smaller chunks.
// I had help from a tutor and help from the internet for the different sorting algorithms 
// explanations on time complexity.
// The  bubble sort took 5 billion operations compared to .5 million operations. 
